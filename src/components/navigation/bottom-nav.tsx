        ...
        {navItems.map((item) => {
          ...
          return (
            <Link
              ...
              className={cn(
                'flex flex-col items-center justify-center gap-1 flex-1 min-w-[44px] min-h-[44px] h-full text-xs font-medium transition-colors rounded-lg focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary',
                isActive
                  ? 'text-primary'
