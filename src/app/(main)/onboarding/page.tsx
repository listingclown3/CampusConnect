...
export default function OnboardingPage() {
  ...
  const handleComplete = () => {
    ...
    const updatedProfile: Profile = {
      ...
      display_name: `${formData.first_name || user.first_name} ${(formData.last_name || user.last_name).charAt(0)}.`,
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start px-4 py-8 bg-gradient-to-br from-[#0055A2]/5 via-background to-[#E5A823]/5">
          ...
          <CardContent className="space-y-4">
            ...
            {step === 2 && (
              <>
                ...
                <div className="space-y-2">
                  <Label>Classes (select your current classes)</Label>
                      ...
                      >
                        <Checkbox
                          ...
                          onCheckedChange={(checked) => {
                            if (checked) {
                              updateField('classes', [...formData.classes, cls.id]);
                            } else {
                              updateField('classes', formData.classes.filter((c) => c !== cls.id));
                            }
                          }}
                        />
                        <div className="flex-1 min-w-0">
                          <p className="text-sm font-medium">{cls.course_code}</p>
                          <p className="text-xs text-muted-foreground truncate">{cls.course_name}</p>
                        </div>
                      </label>
                    ))}
                  </div>
        ...
        <div className="flex gap-3">
          ...
          {step < TOTAL_STEPS ? (
            ...
            <Button
              ...
              className="flex-1 h-11 bg-[#E5A823] hover:bg-[#c48d1a] text-black font-semibold"
            >
              Complete Setup
            </Button>
          )}
