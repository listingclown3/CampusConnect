...
const RELATED_MAJORS: Record<string, string[]> = {
  ...
  Biology: ['Biomedical Engineering', 'Environmental Science', 'Chemistry'],
  'Environmental Science': ['Biology', 'Chemistry'],
  Psychology: ['Communications', 'Sociology'],
  Communications: ['Marketing', 'Psychology', 'English'],
  English: ['Communications', 'Graphic Design'],
